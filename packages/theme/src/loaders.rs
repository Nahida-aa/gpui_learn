...
fn apply_color(colors: &mut ThemeColors, status: &mut StatusColors, key: &str, value: Hsla) {
    match key {
        // ---- 状态色：`状态[.background|.border]`（JSON 里 12 组，我们有 11 组）----
        "conflict" => status.conflict.base = value,
        "conflict.background" => status.conflict.background = value,
        "conflict.border" => status.conflict.border = value,
        "created" => status.created.base = value,
        "created.background" => status.created.background = value,
        "created.border" => status.created.border = value,
        "deleted" => status.deleted.base = value,
        "deleted.background" => status.deleted.background = value,
        "deleted.border" => status.deleted.border = value,
        "error" => status.error.base = value,
        "error.background" => status.error.background = value,
        "error.border" => status.error.border = value,
        "hidden" => status.hidden.base = value,
        "hidden.background" => status.hidden.background = value,
        "hidden.border" => status.hidden.border = value,
        "ignored" => status.ignored.base = value,
        "ignored.background" => status.ignored.background = value,
        "ignored.border" => status.ignored.border = value,
        "info" => status.info.base = value,
        "info.background" => status.info.background = value,
        "info.border" => status.info.border = value,
        "modified" => status.modified.base = value,
        "modified.background" => status.modified.background = value,
        "modified.border" => status.modified.border = value,
        "renamed" => status.renamed.base = value,
        "renamed.background" => status.renamed.background = value,
        "renamed.border" => status.renamed.border = value,
        "success" => status.success.base = value,
        "success.background" => status.success.background = value,
        "success.border" => status.success.border = value,
        "warning" => status.warning.base = value,
        "warning.background" => status.warning.background = value,
        "warning.border" => status.warning.border = value,
        // ---- border 组 ----
